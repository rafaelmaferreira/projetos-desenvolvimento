...
public class UsuarioView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cadastro de Usuários com MVC");
        getContentPane().add(lblTitulo);
        lblTitulo.setBounds(190, 80, 390, 29);
    ...
    private void consultaUsuario() {
        ...
        if (arrayusuario.isEmpty()) {
            ...
            mtb = new MinhaTableModel(arrayusuario, colunas);
    ...
    private void btnPRIMEIROActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPRIMEIROActionPerformed
        ...
        mostraUsuario(arrayusuario.get(1));
    ...
    private void mostraUsuarioAtual() {
        int selecionado = tblConsulta.getSelectedRow();
        mostraUsuario(arrayusuario.get(selecionado));
    }
    private void btnPROXIMOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPROXIMOActionPerformed
        int selecionado = tblConsulta.getSelectedRow();
        if (selecionado < arrayusuario.size()) {
            mostraUsuario(arrayusuario.get(selecionado));
        }
    }//GEN-LAST:event_btnPROXIMOActionPerformed

    private void btnULTIMOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnULTIMOActionPerformed
        mostraUsuario(arrayusuario.get(arrayusuario.size()));
